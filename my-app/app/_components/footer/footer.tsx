    ...
    <div 
        ...
        <div 
            ...
            <div 
                ...
                <span 
                    className='font-bold text-nowrap lg:text-25'>
                    Ready to collect?
                </span>
        ...
        <div 
            ...
            <div 
                className="grid grid-cols-3 gap-4 lg:order-2 lg:gap-10">

                {/* column 1 */}
                <div 
                    className='flex flex-col gap-4 text-16 lg:text-20'>
                    <span 
                        className='text-primary font-bold'>Marketplace</span>
                    <div 
                    ...
                    {/* column 2 */}
                <div 
                    className='flex flex-col text-16 gap-4 lg:text-20'>
                    <span 
                        className='text-primary font-bold'> Category</span>
                    <div 
                        className='flex flex-col gap-2'>
                        <Link href="/">Create</Link>
                        <Link href="/">Mining</Link>
            ...
            <div 
                className="flex flex-col items-center text-center gap-5 lg:items-start lg:text-left lg:justify-between">
                <div>
